...
private[counting] object CountAction {
  ...
  case object AllocateAwayFromIneligibles extends CountAction[Nothing] with Actionable[Nothing]

  sealed trait Actionable[+C]                   extends CountAction[C]
  sealed trait DuringDistribution[+C]           extends CountAction[C]
  sealed trait ActionableDuringDistribution[+C] extends CountAction[C] with Actionable[C] with DuringDistribution[C]
  ...
  case object NoAction extends CountAction[Nothing] with DuringDistribution[Nothing]
